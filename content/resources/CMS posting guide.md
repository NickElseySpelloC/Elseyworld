...
- **Images** — click the image icon, then "Choose an image" to upload from your computer
...
## Step 5: Add a Cover Image (Optional)

If your post type has a **Cover Image** field, click it and upload a photo. This appears as the thumbnail when the post is listed on the Travel Blog page.

For images **inside** the post body, use the image button in the body editor toolbar instead.
