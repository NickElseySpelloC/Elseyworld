---
date: '2026-04-12T18:19:13+10:00'
draft: false
...
> Note: The planner only works on Windows.

### [Download the Time Zone Planner](https://raw.githubusercontent.com/NickElseySpelloC/TimeZonePlanner/main/Time-Zone-Planner.xltm)

{{< img-float src="/img/icons/icon-excel.jpg" href="VFR-Flight-Planner.xltm" side="left" width=50 >}}
Requires Excel 2010 (or later) for Windows. Excel for Mac not supported
{{< clear-float >}}

{{< callout >}}
{{< paypal-donate message="If you find this Time Zone Planner tool useful, please make a small donation." >}}
{{< /callout >}}

{{< img-caption  src="setup-page.png" caption="Setup Page" >}}

{{< img-caption  src="time-chart-page.png" caption="Time Chart Page" >}}
