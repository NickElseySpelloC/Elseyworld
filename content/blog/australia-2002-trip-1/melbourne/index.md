---
title: Melbourne
description: "It's been pissing down all last night, so we rise early (well, fairly early), eager to hit the road, move west and try and out run the rain. It's a fairly easy two hour drive from here to Melbourne."
date: 2002-02-05T00:00:00.000+10:00
author: Nick Elsey
draft: false
thumbnail: melbourne-004.jpg
categories:
...
{{< img-caption-float side="right" src="melbourne-004.jpg" caption="Melbourne State Library" alt="" >}}
...
We're booked into the [Medina Apartments](http://www.sthrncross.com/fact_sheets/melbourne/medinaexecutivesouthyarrafactsheet.htm) just outside Melbourne in an area known as **South Yarra**. This is just down the road from the place we stayed at last time we were here. This is the trendy part of town (of course), full of stylish clothes shops, bakeries, and very tempting looking restaurants.

{{< callout >}}
### Lynn writes...'All about money'

Australian’s have effectively eliminated the nuisance of carrying around piles of small change. When you pay with cash, anything ending with less than three cents gets rounded down; three and four become five. Credit cards do reflect the actual price--which leads one to images of frantic accountants trying to balance the books.
{{< /callout >}}

{{< img-caption-float side="left" src="melbourne-006.jpg" caption="The Exhibition Building" alt="" >}}
...
Melbourne is a very well laid out city and the center is very compact - it's very easy to see many of the sights on foot. I wonder around, taking in the [Melbourne State Library](http://www.slv.vic.gov.au/), the **Exhibition Building**, the very modern looking [Melbourne Museum](http://melbourne.museum.vic.gov.au/), and the [State Parliament Building](http://www.parliament.vic.gov.au/).

{{< img-caption-float side="right" src="melbourne-007.jpg" caption="Melbourne Museum" alt="" >}}

Phew! Time for a sit-down and a beer. I spy the [Windsor Hotel](http://www.oberoihotels.com/oberoi/Australia/Windsor/index.htm) just across the street from the State Parliament Building, the fanciest hotel in town and decide that a bit more sightseeing of the hotel bar would be appropriate.
...
{{< img-caption-float side="left" src="melbourne14.jpg" caption="Shopping Mall" alt="" >}}
...
{{< img-caption src="melbourne-031.jpg" caption="Melbourne from the Botanic Gardens" alt="" >}}
