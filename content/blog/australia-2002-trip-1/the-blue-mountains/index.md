...
date: 2002-02-19T00:00:00.000+10:00
author: Nick Elsey
draft: false
thumbnail: blue-mountains-003.jpg
categories:
...
{{< img-caption-float side="left" src="blue-mountains-003.jpg" caption="Hey, it's a jungle out there!" alt="" >}}
...
It's quite a shock to take an internal flight in Australia after traveling in the US. The security measures over here are nowhere near as extreme (i.e. mindlessly overblown) as in the states. For example -
...
{{< img-caption-float side="left" src="blue-mountains-067.jpg" caption="A scribbly gum" alt="" >}}
...
We leave Sydney in our shiny clean rental car (that won't last long) and head towards the [Blue Mountains](http://www.bluemountainstourism.org.au/). The Blue Mountains are an hour's drive west of Sydney and are really more like large hills than true mountains, but are stunningly beautiful nonetheless. The mountain range is one huge national park, and the highway goes across the main ridge, connecting all the towns along the way. On either side of it there are numerous dramatic cliffs and views out over the valleys, filled with rainforest and no human habitation at all. Wonderful!
...
We spend a fairly lazy day exploring some of the local scenic highlights, and some of the local bakeries too. We drive back out to **Echo Point** so that Lynn can scope out a couple of hotels for an article. Although the prices are a little steep, the [Echoes Hotel](http://www.echoeshotel.com.au/) comes out a winner. It's a boutique hotel (i.e. small - only about a dozen rooms), but it's perched on the cliff top and every room comes with a view to die for. If you're looking for romantic place to sit back, drink bubbly and admire the view, this has to be a winner!

{{< img-caption-float side="right" src="blue-mountains-053.jpg" caption="Govett's Leap Falls" alt="" >}}
...
{{< img-caption-float side="right" src="blue-mountains-076.jpg" caption="Lynn & Nick at Sublime Point" alt="" >}}
...
{{< img-caption-float side="left" src="blue-mountains-052.jpg" caption="Three Sisters" alt="" >}}
...
{{< img-caption-float side="left" src="blue-mountains-084.jpg" caption="Govett's Leap Falls - from the bottom" alt="" >}}
